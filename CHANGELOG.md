...
- **Repo restructure** — code source dans `src/`, installeur et docs a la racine. Donnees utilisateur dans `%LocalAppData%\Fennec` (plus de PermissionError si le script est dans un dossier protege).
