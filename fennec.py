...
def cmd_agent(instruction):
    ...
    if LANG == "en":
        system = (
            ...
            "- After find returns results, go to done with those results. Do NOT call sort or list after find.\n"
            "- find args:[*.ext, folder, 1] with depth=1 searches ONLY the folder itself, not subfolders.\n"
        ...
        system = (
            ...
            "- Apres un find qui retourne des resultats, va en done avec ces resultats. NE PAS appeler sort ou list apres find.\n"
            "- find args:[*.ext, dossier, 1] avec profondeur=1 cherche UNIQUEMENT dans le dossier, pas les sous-dossiers.\n"
